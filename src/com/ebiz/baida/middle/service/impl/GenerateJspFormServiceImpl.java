 ...
 */
public class GenerateJspFormServiceImpl extends BaseFacadeImpl implements GenerateJspFormService {
	...
	public void generateJspForm(TableInfo tableInfo, PropertiesConfig propertiesConfig) {
		...
		String fileName = class_path.concat(class_name).concat("/form.jsp");
		File file = new File(fileName);
		String data = templateService.getContent(ftlPathConfig.getJsp_form_ftl_path(), model);
