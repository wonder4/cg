...
public class GenerateFacadeServiceImpl extends BaseFacadeImpl implements GenerateFacadeService {
	...
	public void generateFacade(TableInfo tableInfo, GenerateCodeConfig generateCodeConfig, List<TableInfo> tableInfoList) {
		...
		String class_path = generateCodeConfig.getBasePath()
				+ StringUtils.substringBeforeLast(ftlPathConfig.getFacade_ftl_path(), "/").concat("/");
		String fileName = class_path.concat("Facade.java");
		File file = new File(fileName);
		String data = templateService.getContent(ftlPathConfig.getFacade_ftl_path(), model);
