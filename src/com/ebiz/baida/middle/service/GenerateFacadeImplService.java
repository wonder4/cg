 ...
 */
public interface GenerateFacadeImplService {

	void generateFacadeImpl(TableInfo tableInfo, GenerateCodeConfig generateCodeConfig, List<TableInfo> tableInfoList);
